const sessionName = "mnytc";
const donet = "https://www.monytccc.eu.org/";
const owner = ["6281319838683"];
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("website https://www.monytccc.eu.org", "yellow"));
